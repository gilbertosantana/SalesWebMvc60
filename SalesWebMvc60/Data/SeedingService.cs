using SalesWebMvc60.Models.Enums;
...
namespace SalesWebMvc60.Data
{
    public static class SeedingService
    {
        ...
        {
            using (var _context = new SalesWebMvc60Context(
                serviceProvider.GetRequiredService<
                    DbContextOptions<SalesWebMvc60Context>>()))
            {
                // Look for any movies
                ...
                Seller s6 = new Seller("Alex Pink", "alep@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
